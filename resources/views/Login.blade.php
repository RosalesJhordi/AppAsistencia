...
<body class="w-full h-screen flex justify-center items-center relative" style="background-repeat: no-repeat; background-position: center; background-size: cover; background-image: url({{asset('img/Fondo.jpg')}});">
    <form action="{{ route('Login') }}" method="POST" class="w-1/4 flex gap-5 flex-col p-2 relative" style="height: 70vh; background: rgb(255, 255, 255);">
      @csrf
      <div class="w-full flex justify-center items-center py-10">
        <img src="{{asset('img/Logo.png')}}" alt="Logo Rosales" class="w-60 h-20">
      </div>
      ...
      <div class="w-full h-auto flex justify-center items-center flex-col gap-2">
        <div class="border border-blue-700 w-96 rounded-sm  p-2 flex items-center justify-center gap-2 focus-within:ring-1 focus-within:ring-blue-500">
          ...
          <input type="email" name="correo" id="correo" placeholder="Email" class="h-full outline-none w-96">
        </div>
        @error('email')
        ...
        <p class="mt-5 text-black font-semibold text-lg">Olvidaste tu contraseña?<a href="" class="font-bold text-blue-600"> Restablecer</a></p>
      </div>
    ...
    <div class="bg-red-500 absolute right-0 w-60 h-20">
